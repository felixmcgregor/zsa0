                ...
                try:
                    ...
                    if hasattr(saved_model, "hparams"):
                        ...
                        if "conv_filter_size" in saved_model.hparams:
                            ...
                            print(
                                f"Current config conv_filter_size: {current_config.conv_filter_size}"
                            )
                            ...
                            if saved_filters != current_config.conv_filter_size:
                                ...
                                current_fc_size = (
                                    current_config.conv_filter_size * 20 * 20
                                )
                                ...
                                if saved_filters == 128:
                                    print(
                                        "🎯 Found it! Saved model was trained with 128 filters = 2560x2560!"
                                    )
                        ...
                        if hasattr(saved_model, "fc_policy"):
                            ...
                            if first_linear:
                                ...
                                if input_size == 2560:
                                    print(
                                        "🎯 Found it! FC layer expects 2560 inputs = 128 filters * 20!"
                                    )
